                    ...
                    <tbody>
                        ...
                        <?php foreach ($solicitudes as $solicitud): ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#confirmModal" data-id="<?php echo $solicitud->idSolicitud; ?>" data-action="aprobar" title="Aprobar">
                                        <i class="fa fa-check-circle text-success" style="font-size: 1.5em;"></i>
                                    </a>
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#confirmModal" data-id="<?php echo $solicitud->idSolicitud; ?>" data-action="rechazar" title="Rechazar" style="margin-left: 10px;">
