<?php foreach ($usuario->result() as $row): ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6">
                <?php echo form_open_multipart("visitante/modificarbdUsuario"); ?>
        ...
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6">
                <?php echo form_open_multipart("visitante/modContra"); ?>
                <div class="form-group">
                    <input type="hidden" class="form-control" name="idUsuario" value="<?php echo $row->idUsuario; ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="contraActual">Contraseña Actual</label>
                    <input type="password" class="form-control" name="nombres" value="" minlength="3" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="nuevaContra">Repita su Nueva Contraseña</label>
                    <input type="password" class="form-control" name="nombres" value="" minlength="3" required>
                </div>
                <div class="row">
                    <div class="col-12" align="center">
