...
<section class="ftco-section">
  <div class="container">
    <div class="row">
      <div class="col-md-4 ftco-animate"><?php echo base_url() ?>
        <div class="work mb-4 img d-flex align-items-end" style="background-image: url('<?php echo base_url() ?>extrasPrincipal/images/lulu.jpg');">
          ...
          <div class="desc w-100 px-4">
            <div class="text w-100 mb-3">
              <span><a href="https://es.wikipedia.org/wiki/Golden_retriever">Golden Retrivier</a></span>
              <h2>Lulu</h2>
              <div class="container">
                <a href="<?php echo base_url() ?>usuario/solicitud" class="btn btn-primary">Solicitar Adopcion</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4 ftco-animate">
        <div class="work mb-4 img d-flex align-items-end" style="background-image: url(<?php echo base_url() ?>extrasPrincipal/images/rocky.jpg);">
          ...
          <div class="desc w-100 px-4">
            <div class="text w-100 mb-3">
              <span><a href="https://es.wikipedia.org/wiki/Labrador_retriever">Labrador</a></span>
              <h2>Rocky</h2>
              <div class="container">
                <a href="<?php echo base_url() ?>usuario/solicitud" class="btn btn-primary">Solicitar Adopcion</a>
              </div>
      ...
      <div class="col-md-4 ftco-animate">
        <div class="work mb-4 img d-flex align-items-end" style="background-image: url(<?php echo base_url() ?>extrasPrincipal/images/max.jpg);">
          ...
          <div class="desc w-100 px-4">
            <div class="text w-100 mb-3">
              <span><a href="https://tecnovet.uchile.cl/index.php/RT/article/view/39057/40703">Chapi</a></span>
              <h2>Max</h2>
              <div class="container">
                <a href="<?php echo base_url() ?>usuario/solicitud" class="btn btn-primary">Solicitar Adopcion</a>
              </div>
      ...
      <div class="col-md-4 ftco-animate">
        <div class="work mb-4 img d-flex align-items-end" style="background-image: url(<?php echo base_url() ?>extrasPrincipal/images/luna.webp);">
          ...
          <div class="desc w-100 px-4">
            <div class="text w-100 mb-3">
              <span><a href="https://es.wikipedia.org/wiki/Gato_siam%C3%A9s">Gato Siamés</a>/span>
              <h2>Luna</h2>
              <div class="container">
                <a href="<?php echo base_url() ?>usuario/solicitud" class="btn btn-primary">Solicitar Adopcion</a>
              </div>
      ...
      <div class="col-md-4 ftco-animate">
        <div class="work mb-4 img d-flex align-items-end" style="background-image: url(<?php echo base_url() ?>extrasPrincipal/images/duke.webp);">
          ...
          <div class="desc w-100 px-4">
            <div class="text w-100 mb-3">
              <span><a href="https://es.wikipedia.org/wiki/Bulldog">Bulldog</a></span>
              <h2>Duke</h2>
              <div class="container">
                <a href="<?php echo base_url() ?>usuario/solicitud" class="btn btn-primary">Solicitar Adopcion</a>
              </div>
      ...
      <div class="col-md-4 ftco-animate">
        <div class="work mb-4 img d-flex align-items-end" style="background-image: url(<?php echo base_url() ?>extrasPrincipal/images/Whiskas.jpg);">
          ...
          <div class="desc w-100 px-4">
            <div class="text w-100 mb-3">
              <span><a href="https://es.wikipedia.org/wiki/Gato_dom%C3%A9stico_de_pelaje_corto">Gatos domestico</a></span>
              <h2>Whiskas</h2>
              <div class="container">
                <a href="<?php echo base_url() ?>usuario/solicitud" class="btn btn-primary">Solicitar Adopcion</a>
              </div>
      ...
      <div class="col-md-4 ftco-animate">
        <div class="work mb-4 img d-flex align-items-end" style="background-image: url(<?php echo base_url() ?>extrasPrincipal/images/Toby.jpg);">
          ...
          <div class="desc w-100 px-4">
            <div class="text w-100 mb-3">
              <span><a href="https://es.wikipedia.org/wiki/Beagle">Beagle</a></span>
              <h2>Toby</h2>
              <div class="container">
                <a href="<?php echo base_url() ?>usuario/solicitud" class="btn btn-primary">Solicitar Adopcion</a>
              </div>
      ...
      <div class="col-md-4 ftco-animate">
        <div class="work mb-4 img d-flex align-items-end" style="background-image: url(<?php echo base_url() ?>extrasPrincipal/images/Simba.jpg);">
          ...
          <div class="desc w-100 px-4">
            <div class="text w-100 mb-3">
              <span><a href="https://es.wikipedia.org/wiki/Gato_dom%C3%A9stico_de_pelaje_corto">Gato Domestico</a></span>
              <h2>Simba</h2>
              <div class="container">
                <a href="<?php echo base_url() ?>usuario/solicitud" class="btn btn-primary">Solicitar Adopcion</a>
              </div>
